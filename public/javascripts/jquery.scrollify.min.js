! function (e, t, n, o) {
    ...
    function i(n, o) {
        return H === !0 ? !0 : void(f[n] && (S.before(n, p), v = 1, S.sectionName && (t.location.hash = f[n]), o ? (e(S.target).stop().scrollTop(d[n]), S.after(n, p)) : (e(S.target).stop().animate({
            scrollTop: d[n]
    ...
    e.scrollify = function (o) {
        ...
        function z(n) {
            e(S.section).each(function (n) {
                d[n] = n > 0 ? parseInt(e(this).offset().top) + S.offset : parseInt(e(this).offset().top), f[n] = S.sectionName && e(this).data(S.sectionName) ? "#" + e(this).data(S.sectionName).replace(/ /g, "-") : "#" + (n + 1), p[n] = e(this), t.location.hash === f[n] && (m = n, y = !0)
            }), !0 === n && i(m, !1)
        }

        function L() {
            return b = e(t).scrollTop(), b > parseInt(d[m]) ? !1 : !0
        }

        function k() {
            return b = e(t).scrollTop(), b < parseInt(d[m]) + (p[m].height() - e(t).height()) ? !1 : !0
        }
        e.easing.easeOutExpo = function (e, t, n, o, i) {
            return t == i ? n + o : o * (-Math.pow(2, -10 * t / i) + 1) + n
        }, a = {
            handleMousedown: function () {
                return H === !0 ? !0 : (w = !1, void(T = !1))
            },
            handleMouseup: function () {
                return H === !0 ? !0 : (w = !0, void(T && a.calculateNearest()))
            },
            handleScroll: function () {
                return H === !0 ? !0 : (u && clearTimeout(u), void(u = setTimeout(function () {
                    return T = !0, w === !1 ? !1 : (w = !1, void a.calculateNearest())
                }, 200)))
            },
            calculateNearest: function () {
                b = e(t).scrollTop();
                for (var n, o = 1, s = d.length, c = 0, u = Math.abs(d[0] - b); s > o; o++) n = Math.abs(d[o] - b), u > n && (u = n, c = o);
                (k() || L()) && (m = c, i(c, !1))
            },
            wheelHandler: function (e, t) {
                ...
                if (t = t || -e.originalEvent.detail / 3 || e.originalEvent.wheelDelta / 120, n - E > 1300 && (D = []), E = n, D.length >= 35 && D.shift(), D.push(Math.abs(10 * t)), M) return !1;
                if (0 > t) {
                    if (m < d.length - 1 && k()) {
                        if (!s(D)) return !1;
                        e.preventDefault(), m++, M = !0, i(m, !1)
                    }
                } else if (t > 0 && m > 0 && L()) {
                    if (!s(D)) return !1;
                    e.preventDefault(), m--, M = !0, i(m, !1)
            ...
            keyHandler: function (e) {
                return H === !0 ? !0 : void(38 == e.keyCode ? m > 0 && L() && (m--, i(m, !1)) : 40 == e.keyCode && m < d.length - 1 && k() && (m++, i(m, !1)))
            },
            init: function () {
                S.scrollbars ? (e(t).bind("mousedown", a.handleMousedown), e(t).bind("mouseup", a.handleMouseup), e(t).bind("scroll", a.handleScroll)) : e("body").css({
                    overflow: "hidden"
                }), e(n).bind("DOMMouseScroll mousewheel", a.wheelHandler), e(n).bind("keydown", a.keyHandler)
            }
        }, h = {
            touches: {
                touchstart: {
            ...
            up: function () {
                m >= 0 && (L() && m > 0 ? (m--, i(m, !1)) : v > 2 ? (v -= 1, c(parseInt(d[m]) + e(t).height() * v)) : (v = 1, c(parseInt(d[m]))))
            },
            init: function () {
        ...
        }, S = e.extend(S, o), N(), z(!1), y === !1 && S.sectionName ? t.location.hash = f[0] : i(m, !1), a.init(), h.init(), e(t).bind("resize", l.handleResize), t.addEventListener("orientationchange", l.handleResize, !1)
        ...
        }), e(t).unbind("resize", l.handleResize), S.scrollbars && (e(t).unbind("mousedown", a.handleMousedown), e(t).unbind("mouseup", a.handleMouseup), e(t).unbind("scroll", a.handleScroll)), e(n).unbind("DOMMouseScroll mousewheel", a.wheelHandler), e(n).unbind("keydown", a.keyHandler), n.addEventListener && (n.removeEventListener("touchstart", h.touchHandler, !1), n.removeEventListener("touchmove", h.touchHandler, !1), n.removeEventListener("touchend", h.touchHandler, !1)), d = [], f = [], p = [], g = []
